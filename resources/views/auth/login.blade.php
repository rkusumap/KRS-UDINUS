        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            ...
            <div class="card card-primary">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ url('login') }}" class="needs-validation" id="form" novalidate="">
                        @csrf
                        ...
                        <div class="form-group">
                            <button type="button" class="btn btn-simpan btn-primary btn-lg btn-block" tabindex="4">
                                Login
                            </button>
                        </div>
                    </form>
            ...
            <div class="simple-footer">
              Copyright &copy; 2018 <div class="bullet"></div> Modified By Radhitya Kusuma
            </div>
          </div>
        </div>
      </div>
            ...
            $('#form').ajaxForm({
                success: function(response) {
                    ...
                    if (response.status==true) {
                        swal({title: "Success!", text: "Berhasil Login", icon: "success"})
                                .then(function(){
                                    document.location='/home';
                            });
                    }
                    else if (response.status==false) {
                        swal({title: "Maaf!", text: response.message, icon: "warning"});
                    }
                    else {
