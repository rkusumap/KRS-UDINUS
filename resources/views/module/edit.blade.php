                    ...
                    <form action="{{ route('module.update',$data->id_module) }}" id="form" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input value="{{ $data->name_module }}" type="text" name="name_module" id="name_module" class="form-control">
                            </div>

                            <div class="form-group">
                                <label>Kode Module</label>
                                <input value="{{ $data->code_module }}" type="text" name="code_module" id="code_module" class="form-control">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="induk_module" id="induk_module" class="form-control select2">
                                    ...
                                    @foreach ($modules as $module)
                                        <option
                                        {{ isSelected($module->id_module, $data->induk_module) }}
                                        value="{{ $module->id_module }}">{{ $module->name_module }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input value="{{ $data->link_module }}" type="text" name="link_module" id="link_module" class="form-control">
                            </div>

                            <div class="form-group">
                                <label>Deskripsi Module</label>
                                <input value="{{ $data->description_module }}" type="text" name="description_module" id="description_module" class="form-control">
                            </div>

                            <div class="form-group">
                                <label>Icon Module</label>
                                <input value="{{ $data->icon_module }}" type="text" name="icon_module" id="icon_module" class="form-control">
                            </div>

                            <div class="form-group">
                                <label>Aksi Module</label>
                                <input value="{{ $data->action_module }}" type="text" name="action_module" id="action_module" class="form-control">
                            </div>

                            <div class="form-group">
                                <label>Urutan</label>
                                <input value="{{ $data->order_module }}" type="number" name="order_module" id="order_module" class="form-control">
                            </div>
                        </div>
