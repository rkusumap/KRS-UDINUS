...
<section class="section">
    ...
    <div class="section-body">
        <h2 class="section-title">Hak Akses description</h2>
                ...
                <div class="card">
                    <div class="card-body">
                        @if (isAccess('create', $get_module, auth()->user()->level_user))
                            <a class="btn btn-primary mb-3" href="{{ url('permission/create') }}">Tambah</a>
                        @endif
                        <div class="">
