    ...
    <div class="section-body">
        ...
        <div class="row">
            <div class="col-12 col-md-12 col-lg-12">
                <div class="card">
                    <form action="{{ route('users.update',$data->id) }}" id="form" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <select name="level_user" id="level_user" class="form-control select2">
                                    ...
                                    @foreach ($dataLevel as $level)
                                        <option {{ isSelected($level->id_level, $data->level_user) }} value="{{ $level->id_level }}"> {{ $level->name_level }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="status_user" id="status_user" class="form-control select2">
                                    ...
                                    <option {{ isSelected(1, $data->status_user) }} value="1">Aktif</option>
                                    <option {{ isSelected(0, $data->status_user) }} value="0">Tidak Aktif</option>
                                </select>
                            </div>
